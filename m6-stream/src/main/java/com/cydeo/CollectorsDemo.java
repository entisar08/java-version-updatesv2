...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        Set<Integer> numberSet = numbers.stream()
                .filter(x -> x%2==0)
                .collect(Collectors.toCollection(HashSet::new));//using suppliar interface
        ...
        //the functions to convert the stream into value and key based on what you specify
        ...
        //joining(): is used to join various elements of a character or string array into a single object aka concatenation
...
//what are the difference between partinoing and groupin by
