...
//this will return long decimal number high precision
        BigDecimal b1 = new BigDecimal("374.56");//pass string in big decimal
        BigDecimal b2 = new BigDecimal("374.26");
       // BigDecimal b3=b1-b2;
        // you cant substract object
        //instead do b1.substract(b2) it convert them to numvbers
